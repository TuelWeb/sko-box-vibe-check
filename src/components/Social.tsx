  ...
  const socialNetworks = [
    {
      ...
      url: "https://www.tiktok.com/@skobox",
      bgClass: "bg-black",
    ...
    },
    {
      ...
      url: "https://www.instagram.com/skobox",
      bgClass: "bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-500",
      textClass: "text-white",
    },
  ];

  return (
    <section id="social" className="py-20 bg-skobox-gray">
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg max-w-3xl mx-auto">
            Suis-moi pour voir les drops en avant-première, les prix, et les bons plans streetwear !
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          {socialNetworks.map((social, index) => (
            <motion.a
              ...
              className={`${social.bgClass} ${social.textClass} rounded-lg p-6 flex items-center justify-between shadow-lg hover:shadow-xl transition-shadow duration-300`}
            >
        ...
        >
          <p className="text-lg mb-6">
            Ne rate aucun drop et reste informé des nouvelles pièces dispo !
          </p>
